<template>
  <div class="recherche">
    ...
    <form
      class="recherche__ajout"
      action="https://webby.houlle.org/wp-admin/post-new.php?post_type=tuto"
    >
